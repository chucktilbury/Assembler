    ...
    while(obj != NULL) {
        ...
        switch(obj->type) {
            ...
            case OT_CLASS2_INSTR: {
                ...
                ptr->addr = getAddr();
                writeInst8(ptr->op);
                writeInst8((ptr->right & 0xF) | ((ptr->left & 0xF) << 4));
            } break;
            case OT_CLASS3_INSTR: {
                Class3* ptr = (Class3*)obj;
                ptr->addr = getAddr();
                writeInst8(ptr->op);
                writeInst16((ptr->right & 0xF) | ((ptr->left & 0xF) << 4) |
                            ((ptr->dest & 0xF) << 8));
            } break;
            ...
            case OT_CLASS9_INSTR: {
                ...
                ptr->addr = getAddr();
                writeInst8(ptr->op);
                writeInst8((ptr->base & 0xF) | ((ptr->dest & 0xF) << 4));
                writeInst16(ptr->val);
            } break;
