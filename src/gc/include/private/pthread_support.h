...
GC_INNER void GC_record_stack_base(GC_thread me, const struct GC_stack_base* sb);
...
#if defined(GC_PTHREADS) && !defined(SN_TARGET_ORBIS) && !defined(SN_TARGET_PSP2)
...
GC_INNER_PTHRSTART void* GC_CALLBACK GC_pthread_start_inner(struct GC_stack_base* sb,
                                                            void* arg);
GC_INNER_PTHRSTART GC_thread GC_start_rtn_prepare_thread(void* (**pstart)(void*),
                                                         void** pstart_arg,
