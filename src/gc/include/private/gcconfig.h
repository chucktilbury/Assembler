...
!defined(__CEGCC__) && !defined(NN_PLATFORM_CTR) && !defined(GC_NO_NOSYS) && \
...
!defined(LINUX) && !defined(FREEBSD) && !defined(NETBSD) && !defined(OPENBSD)
#define MIPS
...
(defined(DARWIN) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(OPENBSD))
#define AARCH64
#define mach_type_known
...
(defined(DARWIN) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || \
 defined(OPENBSD) || defined(NN_PLATFORM_CTR) || defined(SN_TARGET_PSP2))
#define ARM32
#define mach_type_known
...
(defined(DARWIN) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || \
 defined(OPENBSD) || defined(__QNX__))
#define I386
#define mach_type_known
...
#define M32R
#define mach_type_known
#elif((defined(__m68k__) || defined(m68k)) && (defined(NETBSD) || defined(OPENBSD))) || \
...
#define GC_HAVE_DATAREGION2
#define DATASTART2 \
    (_DYNAMIC_LINKING ? (ptr_t)(((word)_gp + 0x8000 + 0x3ffff) & ~0x3ffff) : (ptr_t)edata)
#define DATAEND2 ((ptr_t)(end))
#define ALIGNMENT 4
#endif
#endif
...
((defined(MIPS) && (CPP_WORDSZ == 32)) || defined(ARM32) || defined(I386) /* but not x32 */)
...
#if defined(FREEBSD) && \
(defined(__DragonFly__) || __FreeBSD__ >= 4 || __FreeBSD_kernel__ >= 4 || defined(__GLIBC__))
#define SUNOS5SIGS
#endif

#if defined(FREEBSD) || defined(HAIKU) || defined(HURD) || defined(IRIX5) || \
defined(NETBSD) || defined(OPENBSD) || defined(OSF1) || defined(SUNOS5SIGS)
...
defined(BSD) || defined(HAIKU) || defined(HURD) || defined(AIX) ||          \
...
defined(LINUX) || defined(NETBSD) || defined(OPENBSD) || defined(SOLARIS) ||   \
((defined(CYGWIN32) || defined(USE_MMAP) || defined(USE_MUNMAP)) && !defined(USE_WINALLOC))
...
(defined(SN_TARGET_PS3) || defined(SN_TARGET_PSP2) || defined(MSWIN_XBOX1))
...
defined(MPROTECT_VDB) && !defined(DARWIN) && !defined(MSWIN32) && !defined(MSWINCE)
#undef MPROTECT_VDB
#endif
...
#define NO_VDB_FOR_STATIC_ROOTS
     ...
     (defined(DARWIN) || defined(HAIKU) || defined(HURD) || defined(OPENBSD) || defined(ARM32) || \
      defined(AVR32) || defined(MIPS) || defined(NIOS2) || defined(OR1K))) ||                     \
...
(defined(CYGWIN32) && defined(I386) && defined(USE_MMAP) && !defined(USE_WINALLOC)) || \
(defined(NETBSD) && defined(__ELF__)) || defined(OPENBSD) ||                           \
((defined(SVR4) || defined(AIX) || defined(DGUX) ||                                    \
  defined(DATASTART_USES_BSDGETDATASTART) || (defined(LINUX) && defined(SPARC))) &&    \
 !defined(PCR))
#define NEED_FIND_LIMIT
#endif
...
#if defined(GC_LINUX_THREADS) && defined(REDIRECT_MALLOC) && \
defined(__GLIBC__) && !GC_GLIBC_PREREQ(2, 34) && !defined(HAVE_LIBPTHREAD_SO)
...
(!defined(MSWIN32) && !defined(MSWINCE) && !defined(CYGWIN32) &&           \
 (defined(GC_DISABLE_INCREMENTAL) || defined(DEFAULT_VDB)) && !defined(USE_MMAP))
...
!defined(GC_WIN32_THREADS) && !defined(PLATFORM_STOP_WORLD) && !defined(SN_TARGET_PSP2)
...
(defined(HPUX) || defined(GC_DGUX386_THREADS) || defined(NO_GETCONTEXT) /* e.g. musl */)
...
#if !defined(CAN_HANDLE_FORK) && !defined(NO_HANDLE_FORK) && !defined(HAVE_NO_FORK) && \
...
!defined(GC_NO_CAN_CALL_ATFORK) && !defined(HOST_TIZEN) && !defined(HURD) && \
...
#define NEED_CALLINFO
    ...
    (defined(SOLARIS) && (!defined(_XOPEN_SOURCE) || defined(__EXTENSIONS__))) || \
    defined(LINUX)) &&                                                            \
!defined(HAVE_DLADDR)
...
#define GET_MEM(bytes) \
    HBLKPTR((ptr_t)os2_alloc(SIZET_SAT_ADD(bytes, GC_page_size)) + GC_page_size - 1)
#elif defined(NEXT) || defined(DOS4GW) || defined(NONSTOP) || \
(defined(AMIGA) && !defined(GC_AMIGA_FASTALLOC)) ||           \
(defined(SOLARIS) && !defined(USE_MMAP)) || defined(RTEMS) || defined(__CC_ARM)
#define GET_MEM(bytes) \
    HBLKPTR((size_t)calloc(1, SIZET_SAT_ADD(bytes, GC_page_size)) + GC_page_size - 1)
...
#define GET_MEM(bytes) \
    HBLKPTR(GC_MacTemporaryNewPtr(SIZET_SAT_ADD(bytes, GC_page_size), true) + GC_page_size - 1)
#else
#define GET_MEM(bytes) \
...
#define GET_MEM(bytes) \
    HBLKPTR((size_t)GC_amiga_get_mem(SIZET_SAT_ADD(bytes, GC_page_size)) + GC_page_size - 1)
