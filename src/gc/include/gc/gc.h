...
typedef void(GC_CALLBACK* GC_on_thread_event_proc)(GC_EventType, void* /* thread_id */);
...
GC_API GC_ATTR_MALLOC char* GC_CALL GC_strndup(const char*, size_t) GC_ATTR_NONNULL(1);
GC_API GC_ATTR_MALLOC GC_ATTR_ALLOC_SIZE(1) void* GC_CALL
...
GC_ATTR_NONNULL(1);
#ifndef GC_NO_VALLOC
GC_API GC_ATTR_MALLOC GC_ATTR_ALLOC_SIZE(1) void* GC_CALL GC_valloc(size_t /* lb */);
GC_API GC_ATTR_MALLOC GC_ATTR_ALLOC_SIZE(1) void* GC_CALL GC_pvalloc(size_t /* lb */);
#endif /* !GC_NO_VALLOC */
...
GC_API int GC_CALL GC_try_to_collect(GC_stop_func /* stop_func */) GC_ATTR_NONNULL(1);
...
GC_API size_t GC_CALL GC_get_prof_stats(struct GC_prof_stats_s*, size_t /* stats_sz */);
#ifdef GC_THREADS
...
/* avoid data races on multiprocessors.                               */
GC_API size_t GC_CALL GC_get_prof_stats_unsafe(struct GC_prof_stats_s*, size_t /* stats_sz */);
#endif
...
GC_API GC_ATTR_MALLOC char* GC_CALL GC_debug_strdup(const char*, GC_EXTRA_PARAMS);
...
GC_API GC_ATTR_DEPRECATED void*
GC_CALL GC_debug_malloc_stubborn(size_t /* size_in_bytes */, GC_EXTRA_PARAMS);
GC_API GC_ATTR_MALLOC GC_ATTR_ALLOC_SIZE(1) void* GC_CALL
GC_debug_malloc_ignore_off_page(size_t /* size_in_bytes */, GC_EXTRA_PARAMS);
GC_API GC_ATTR_MALLOC GC_ATTR_ALLOC_SIZE(1) void* GC_CALL
GC_debug_malloc_atomic_ignore_off_page(size_t /* size_in_bytes */, GC_EXTRA_PARAMS);
...
GC_API void GC_CALL GC_debug_end_stubborn_change(const void*) GC_ATTR_NONNULL(1);
...
GC_debug_realloc_replacement(void* /* object_addr */, size_t /* size_in_bytes */);
...
#define GC_GENERAL_REGISTER_DISAPPEARING_LINK(link, obj) \
    GC_general_register_disappearing_link(link, GC_base((/* no const */ void*)(obj)))
...
GC_API GC_ATTR_MALLOC wchar_t* GC_CALL GC_wcsdup(const wchar_t*) GC_ATTR_NONNULL(1);
GC_API GC_ATTR_MALLOC wchar_t* GC_CALL GC_debug_wcsdup(const wchar_t*, GC_EXTRA_PARAMS)
GC_ATTR_NONNULL(1);
#ifdef GC_DEBUG
...
typedef void(GC_CALLBACK* GC_finalization_proc)(void* /* obj */, void* /* client_data */);
...
/* finalization order.                                          */
GC_API int GC_CALL GC_register_disappearing_link(void** /* link */) GC_ATTR_NONNULL(1);
...
GC_API int GC_CALL GC_general_register_disappearing_link(void** /* link */, const void* /* obj */)
...
#if defined(__e2k__)
#define GC_reachable_here(ptr) __asm__ __volatile__(" " : : "r"(ptr) : "memory")
#else
...
typedef void*(GC_CALLBACK* GC_stack_base_func)(struct GC_stack_base* /* sb */, void* /* arg */);
...
GC_API int GC_CALL GC_register_my_thread(const struct GC_stack_base*) GC_ATTR_NONNULL(1);
...
GC_API void* GC_CALL GC_get_my_stackbottom(struct GC_stack_base*) GC_ATTR_NONNULL(1);
...
GC_API void GC_CALL GC_set_stackbottom(void* /* gc_thread_handle */,
                                       const struct GC_stack_base*) GC_ATTR_NONNULL(2);
...
GC_API void* GC_CALL GC_pre_incr(void**, ptrdiff_t /* how_much */) GC_ATTR_NONNULL(1);
GC_API void* GC_CALL GC_post_incr(void**, ptrdiff_t /* how_much */) GC_ATTR_NONNULL(1);
...
GC_API void GC_CALL GC_register_has_static_roots_callback(GC_has_static_roots_func);
...
(!defined(GC_PTHREADS) || defined(GC_BUILD) || defined(GC_WINDOWS_H_INCLUDED))
...
#define GC_DATASTART                                                            \
    ((GC_word)__data_start__ < (GC_word)__bss_start__ ? (void*)__data_start__ : \
                                                        (void*)__bss_start__)
#define GC_DATAEND \
    ((GC_word)__data_end__ > (GC_word)__bss_end__ ? (void*)__data_end__ : (void*)__bss_end__)
#else
extern int _data_start__[], _data_end__[], _bss_start__[], _bss_end__[];
#define GC_DATASTART \
    ((GC_word)_data_start__ < (GC_word)_bss_start__ ? (void*)_data_start__ : (void*)_bss_start__)
#define GC_DATAEND \
    ((GC_word)_data_end__ > (GC_word)_bss_end__ ? (void*)_data_end__ : (void*)_bss_end__)
#endif /* !__x86_64__ */
...
#define GC_INIT_CONF_ROOTS                                                          \
    (void)(__dso_handle != 0 ?                                                      \
           (GC_add_roots(__dso_handle, GC_find_limit(__dso_handle, 1 /*up*/)), 0) : \
           0)
#else
