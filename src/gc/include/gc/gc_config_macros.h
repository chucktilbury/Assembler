...
defined(GC_HPUX_THREADS) || defined(GC_IRIX_THREADS) || defined(GC_LINUX_THREADS) || \
...
#elif(defined(__DragonFly__) || defined(__FreeBSD_kernel__) || defined(__FreeBSD__)) && \
...
!(defined(nec_ews) || defined(_nec_ews) || defined(ultrix) || defined(__ultrix))
#define GC_IRIX_THREADS
#elif defined(__sparc) /* && !Linux */  \
|| ((defined(sun) || defined(__sun)) && \
    (defined(i386) || defined(__i386__) || defined(__amd64) || defined(__amd64__)))
#define GC_SOLARIS_THREADS
...
((defined(_DLL) && !defined(__GNUC__)) || (defined(DLL_EXPORT) && defined(GC_BUILD)))
#define GC_DLL
#endif
...
#include <features.h>
#endif
#if(__GLIBC__ == 2 && __GLIBC_MINOR__ >= 1 || __GLIBC__ > 2) && !defined(__ia64__) && \
!defined(GC_MISSING_EXECINFO_H) && !defined(GC_HAVE_BUILTIN_BACKTRACE)
...
!defined(GC_HAVE_NO_BUILTIN_BACKTRACE) && !defined(GC_HAVE_BUILTIN_BACKTRACE)
#define GC_HAVE_BUILTIN_BACKTRACE
#endif
...
/* retrieve the call chain.                                             */
    ...
    defined(__OpenBSD__) || defined(HOST_ANDROID) || defined(__ANDROID__)) &&   \
...
!defined(__ANDROID__) && (defined(GC_LINUX_THREADS) || defined(GC_SOLARIS_THREADS))
#define GC_HAVE_PTHREAD_EXIT
...
#ifndef GC_NOEXCEPT
#if defined(__DMC__) ||                                                                     \
(defined(__BORLANDC__) && (defined(_RWSTD_NO_EXCEPTIONS) || defined(_RWSTD_NO_EX_SPEC))) || \
