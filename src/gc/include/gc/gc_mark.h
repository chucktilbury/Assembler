...
GC_API void GC_CALL GC_iterate_free_hblks(GC_walk_free_blk_fn, GC_word /* client_data */)
GC_ATTR_NONNULL(1);

typedef void(GC_CALLBACK* GC_walk_hblk_fn)(struct GC_hblk_s*, GC_word /* client_data */);
...
GC_API void GC_CALL GC_apply_to_all_blocks(GC_walk_hblk_fn, GC_word /* client_data */)
GC_ATTR_NONNULL(1);
...
GC_API struct GC_hblk_s* GC_CALL GC_is_black_listed(struct GC_hblk_s*, GC_word /* len */);
...
GC_API void GC_CALL GC_register_describe_type_fn(int /* kind */, GC_describe_type_fn);
...
typedef void(GC_CALLBACK* GC_reachable_object_proc)(void* /* obj */,
                                                    size_t /* bytes */,
                                                    void* /* client_data */);
GC_API void GC_CALL GC_enumerate_reachable_objects_inner(GC_reachable_object_proc,
                                                         void* /* client_data */)
GC_ATTR_NONNULL(1);
