...
GC_API void GC_CALL GC_init_gcj_malloc(int mp_index, void* /* really GC_mark_proc */ mp) {
...
#define ignore_gcj_info TRUE
    ...
    if(ignore_gcj_info) {
        ...
        GC_gcj_kind =
        GC_new_kind_inner((void**)GC_gcjobjfreelist,
...
GC_INNER void* GC_core_gcj_malloc(size_t lb, void* ptr_to_struct_containing_descr)
#else
GC_API GC_ATTR_MALLOC void* GC_CALL GC_gcj_malloc(size_t lb, void* ptr_to_struct_containing_descr)
#endif
{
    ptr_t op;
    DCL_LOCK_STATE;
...
GC_API GC_ATTR_MALLOC void* GC_CALL GC_gcj_malloc_ignore_off_page(size_t lb, void* ptr_to_struct_containing_descr) {
    ptr_t op;
    DCL_LOCK_STATE;
